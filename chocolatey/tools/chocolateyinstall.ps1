...
$url32       = 'https://github.com/MoriokaReimen/Task-Fighter/releases/download/9.0.0/task-fighter-9.0.0-i686-pc-windows-msvc.zip'
$url64       = 'https://github.com/MoriokaReimen/Task-Fighter/releases/download/9.0.0/task-fighter-9.0.0-x86_64-pc-windows-msvc.zip'
